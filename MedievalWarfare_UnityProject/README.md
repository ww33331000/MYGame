...
> 即使你完全不会 Unity，跟着下面的步骤也能运行游戏

### 第 1 步：安装 Unity（免费）

1. 下载 **Unity Hub**：https://unity.com/download
2. 安装并打开 Unity Hub
3. 点击左侧 **"Installs"** → 右上角 **"Install Editor"**
4. 选择 **Unity 2022.3 LTS**（长期支持版）
5. 勾选 **"WebGL Build Support"**（可选，用于构建网页版）
6. 点击 **"Continue"** 等待安装完成

### 第 2 步：打开项目

1. 在 Unity Hub 中点击 **"Projects"** → **"Add"** → **"Add project from disk"**
2. 选择 `MedievalWarfare_UnityProject` 文件夹
3. 等待 Unity 导入项目（第一次可能需要几分钟）

### 第 3 步：生成场景

1. 项目打开后，在顶部菜单栏找到 **"中世纪战争"**
2. 点击 **"一键生成所有场景"**
3. 等待几秒钟，弹出「生成完成」对话框即可

### 第 4 步：运行游戏

1. 在左下角 **Project** 窗口中，找到 `Assets/Scenes/MainMenu.unity`
2. **双击**打开主菜单场景
3. 点击顶部中间的 **▶ Play** 按钮
4. 开始游戏！
...
- 菜单：**中世纪战争 → 构建 → Windows版本**（或 Mac/Linux/WebGL）
- 构建完成后，`Build/` 文件夹里就是可以直接运行的程序
